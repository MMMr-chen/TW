...
public class Lancer extends Player{
    ...
    private static String role="骑士";
    private static int launchType=2;
    private static List<Integer> usertypelist=new ArrayList<Integer>(){{add(1);add(2);}};
    public Lancer(int attack,int health,String name){
